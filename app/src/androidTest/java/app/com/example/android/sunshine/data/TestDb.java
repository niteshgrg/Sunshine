...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertFalse("Error: Location Row not inserted correctly", locationRowId == -1L);
        ...
        assertFalse("Error: More than one recorn returned from weather query", weatherCursor.moveToNext());
